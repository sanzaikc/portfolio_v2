    ...
    <div id="about" className="pb-20 lg:min-h-screen lg:pb-0">
      ...
      <div className="flex flex-col space-y-8 lg:flex-row-reverse  lg:space-y-0">
        <div className="group relative h-72 w-full lg:h-[400px] lg:w-80">
          <div className="absolute inset-0 hidden translate-x-4 translate-y-4 rounded border-2 border-blue-400 border-opacity-25 transition duration-200 ease-in group-hover:translate-x-0 group-hover:translate-y-0 lg:block"></div>
          <img
            src={Profile}
            alt="Profile"
            className="absolute inset-0 h-full w-full rounded object-cover object-center"
          />
          <div className="absolute inset-0 hidden rounded bg-blue-600 bg-opacity-40 transition-all duration-200 ease-out group-hover:bg-opacity-0 lg:block"></div>
        </div>
